...
<LISTBOXSLIDER_2>
  ...
  pElemRef = gslc_ElemXSliderCreate(&m_gui,$<BAR-113>,$<COM-000>,&m_sListScroll$<COM-018>,
          (gslc_tsRect){$<COM-003>+$<COM-005>-22,$<COM-004>+4,$<SLD-111>,$<COM-006>-8},0,$<BAR-115>,0,$<SLD-103>,true);
...
<TEXTBOXSLIDER_2>
  ...
  pElemRef = gslc_ElemXSliderCreate(&m_gui,$<BAR-113>,$<COM-000>,&m_sTextScroll$<COM-018>,
          (gslc_tsRect){$<COM-003>+$<COM-005>-21,$<COM-004>+4,$<SLD-111>,$<COM-006>-8},0,$<BAR-115>,0,$<SLD-103>,true);
  gslc_ElemSetCol(&m_gui,pElemRef,$<BAR-116>,$<BAR-117>,$<BAR-116>);
  gslc_ElemXSliderSetPosFunc(&m_gui,pElemRef,&CbSlidePos);
  $<BAR-114> = pElemRef;
<STOP>
